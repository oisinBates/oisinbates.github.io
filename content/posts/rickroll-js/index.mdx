...
I’ve always found it interesting how some people can be fascinated by the sight of terminals printing logs. The logs could be nonsense, but the sight itself is often enough to attract attention. In this sense, it’s the perfect opportunity for [Rickrolling](https://en.wikipedia.org/wiki/Rickrolling).
