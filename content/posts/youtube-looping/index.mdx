...
A working demo is hosted [here](https://codepen.io/oisinbates/full/RMYawb) and source code is [viewable on GitHub](https://github.com/oisinBates/youtube_looping_and_slowing).